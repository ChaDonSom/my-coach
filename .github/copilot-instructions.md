...
The .clinerules file is your learning journal for each project. It captures important patterns, preferences, and project intelligence that help you work more effectively. As you work with the user and the project, you'll discover and document key insights that aren't obvious from the code alone.
...
The format is flexible - focus on capturing valuable insights that help you work more effectively with the user and the project. Think of .clinerules as a living document that grows smarter as we work together.
